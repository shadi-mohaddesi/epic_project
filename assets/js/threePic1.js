let threePic1 = document.querySelector(".threePic1");

let loadThreePic1 = async () => {
  try {
    ...
    let result = res.threePic1
      ...
      .join("");
    threePic1.insertAdjacentHTML("afterbegin", result);
  } catch (error) {
    console.log(error.message);
  }
};

export default loadThreePic1;
