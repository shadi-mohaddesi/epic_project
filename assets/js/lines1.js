let root = document.querySelector(".lines1 .swiper .swiper-wrapper");

async function loadlines1() {
  try {
            ...
            <div class="contente">
              ...
              <div class="content">
                ...
                <div>
                  ...
                  ${
                    prod.before
                      ? `<span class="before">${prod.before}</span>`
                      : ""
                  }
                  ${
                ...
                ${
                  prod.button
                    ? `<div class="button"><a href="${prod.href}">${prod.button}</a></div>`
                    : ""
                }
              </div>
            </div>
